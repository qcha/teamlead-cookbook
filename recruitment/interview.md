...
В разных компаниях процесс собеседования построен по своему: где-то 3 этапа, где-то 2, где-то вообще 5 и более.
...
Однако, не смотря на это, общие темы можно выделить и проговорить.
...
Под исходными данными я подразумеваю любые данные, которые на вас могут повлиять: срочность закрытия вакансии, возможность влиять на процесс найма (не во всех организациях это возможно), грейдовый состав и загруженность команды, культуру и т.д.

Например: у вас сплоченная команда и вы достаточно спокойно понимаете, что можно взять стажера/джуна для постепенного его роста и усиления команды. Так как это не критичная вакансия, то тратить время (а значит и деньги) на такое количество этапов - не имеет смысла. И вы просто убираете большую часть этапов, возможно, заменяя что-то тестовым заданием даже.

### Разговор с HR

Так как вы, как руководитель, уже составили [портрет кандидата](./job_description.md#портрет-для-найма) заранее, то проконтролируйте, что ваш HR этот портрет увидел(а).

По возможности, лучше даже созвониться и по нему пробежаться вместе.

Обычно у HR-специалистов, в силу специфики профессии, достаточно неплохо получается видеть плюсы и минусы кандидатов. Это не всегда получается, но в среднем лучше этим пользоваться. Отсюда, чем более схоже вы представляете искомого кандидата - тем более качественный отбор будет к следующему этапу - техническому собеседованию.
...
Если есть возможность, то лучше попросить HR давать некоторую выжимку информации, впечателния по кандидатам, которые проходят на следующий этап, техническое собеседование.

На мой взгляд, вот эта не синхронизированность с HR - это первая ошибка и ее много кто допускает.

### Техническое собеседование по ЯП

Казалось бы, что здесь все просто. Понятно, что надо оценить кандидата по хард-скиллам и принять решение о допуске на следующий этап или нет.

Бывает, что это собеседование проводите вы, как тимлид, бывает, что это ваш коллега, также случается то, что собеседование проводит вообще не относящийся к вам программист(ы) компании.

И первый, как мне кажется, подводный камень тут в том, что на этом этапе должны спрашивать вопросы именно по тому, что у вас написано в описании вакансии, в разделе 'Ожидания'.

Но на деле очень часто встречается то, что спрашивают либо вообще все вопросы, какие собеседующему приходят в голову, либо просто по некоему существующему чек-листу. При этом сам чек-лист не всегда совпадает с именно вашей спецификой.

Зачастую это некий 'общий' чек-лист на компанию под всех и там достаточно много тем: и распределенные системы, по многопоточности, по работе под высокой нагрузкой, про SQL, про NoSQL, паттерны - да огромное количество всего.

И вот часто собеседующие идут прямо по списку, либо по каким-то своим любимым темам, что иногда может не совпадать с теми самыми 'Ожиданиями'.

Грубо говоря, вы ожидаете кандидата с умением работы с SQL (сложные запросы), большим опытом в реляционных БД, готовы закрыть глаза на слабые знания в многопоточности Java, приходит такой кандидат и его спрашивают по многопоточности в Java, по распределенным системам и он не проходит или получает низкий грейд оценки, после чего уходит к вашим конкурентам.

Это не говорит о том, что не надо спрашивать эти вопросы, смысл в том, чтобы спрашивать их тогда, когда вы уже хотите понять кругозор. Но до этого надо вообще понять - подойдет ли он под задачи и требоания.

В идеале вообще подготовить свой чек-лист по тому, что вы ожидаете от человека.

Как это лучше сделать?

Из описания требований по вакансии и примерным планируемым задачам выделить основные блоки.
...
- Испольуете Spring Boot для ваших сервисов
...
В таком случае, можно явно выделить следующие блоки:

* Блок про опыт кандидата

    Здесь важно понять насколько человек понимал что он делал на прошлой работе. Чем более ясно и четко кандидат сможет рассказать суть прошлого проекта/проектов, чем более хорошо он понимает предметную область, в которой работал - тем ценнее этот кандидат.
...
Будем честны, зачастую, кандидатов, кто с нуля проектировал системы, не так много, большая часть именно готовится по каким-то материалом (типа Cracking Design Review).
...
Во-первых, некоторые вопросы или проблемы, некоторые темы вы, возможно, хотели бы обсудить не на общем кругу. Например, кандидат спросит: а куда делся прошлый разработчик/тимлид/аналитик/тестировщик? Или, задаст вопрос по тому, какие будут его первые задачи? Слушать это всем, как мне кажется, не обязательно.

Во-вторых, эта встреча это как пред-финал, а командное время стоит очень дорого. Вдобавок к этому, это тратит и силы, сбивает фокус с текущих задач сотрудников.

Поэтому, я бы разделял этапы и только когда все уже готово, когда уже по сути мы можем сделать оффер, то проводить знакомство с командой.
...
Звать на эту встречу прямо всю команду, на мой взгляд, не стоит, так как это не принесет той пользы, что мы бы ожидали за такую встречу. Плюс, многих кандидатов большое количество новых и незнакомых еще людей может пугать.

В идеале - это позвать нескольких лидеров команды, обязательно того, кто (по вашему плану) будет наставником или эдаким buddy, человеком, к которому новичок всегда может обратиться и который его будет погружать в курс дела.
...
Исключения может составлять разве что найм стажеров, где по такому ДЗ можно построить диалог собеседования впоследствии.
...
Отсутствие обратной связи является неприятным фактом и вредит репутации компании, усложняет дальнейший найм (так как новости о 'плохих' компаниях быстро распространяются).
