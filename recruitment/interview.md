...
Обычно у HR-специалистов, в силу специфики профессии, достаточно неплохо получается видеть плюсы и минусы кандидатов. Это не всегда получается, но в целом полезно этим воспользоваться Отсюда, чем более схоже вы представляете искомого кандидата - тем более качественный отбор будет к следующему этапу - техническому собеседованию.
...
Зачастую это некий 'общий' чек-лист на компанию под всех и там достаточно много тем: распределенные системы, многопоточность, по работе под высокой нагрузкой, про SQL, про NoSQL, паттерны - да огромное количество всего.
...
Это не говорит о том, что не надо спрашивать эти вопросы, смысл в том, чтобы спрашивать их тогда, когда вы уже хотите понять кругозор. Но до этого надо вообще понять - подойдет ли он под задачи и требования.
