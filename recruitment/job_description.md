...
- [Составление вакансии](#составление-вакансии)
    ...
    - [Распространенные ошибки](#распространенные-ошибки)
        ...
        - [Пример 3 (неплохой)](#пример-3-неплохой)
...
По сути, описание вакансии - это ваше лицо. От того какое вы произведете впечатление и насколько сможете заинтересовать потенциального кандидата зависит как количество откликов, так и внимание к вашей компании, желание взаимодействовать с ней.
...
Вакансии, не составленные должным образом, сталкиваются с проблемой слабой заинтересованности, малого количества откликов, что усложняет поиск кандидата и растягивает время закрытия вакансии. Также такие вакансии могут столкнуться наоборот с слишком большим количеством откликов, что может отразиться на времени разбора откликов и потенциальной потерей кандидатов (никто не будет ждать неделями пока вы разгребете завал).
...
Обычно такой блок так и называют - о нас.
...
Проконтролируйте, что этот блок в вашей вакансии описан верно, проверьте его на ошибки! Из моего опыта были случаи, когда этот блок был настолько непонятным, что даже я не мог понять, что это в мое подразделение вакансия.

Этап знакомства пройден и далее надо переходить к делу, т.е. к тем задачам, которые надо решать в этой роли.

### Чем предстоит заниматься

Этот блок схож с тем, что бы вы видели в резюме в разделе 'Обязанности'.
...
Можете даже сравнить написанный раздел 'Обязанности' выше и то, что написано здесь, провести корреляцию. И там, и тут описание было на Java Middle/Middle+.

Чем более размыто написано - тем больше воронка найма. А значит, это та самая проблема, когда откликов будет много, но многие из них будут не подходить уже на этапе разговора с HR или на техническом собеседовании. Соответственно, если вам необходим более узкоспециализированный специалист - сформулируйте этот раздел более конкретно.

Например, у меня был случай, когда я приехал на собеседование по довольно стандартной вакансии Java разработчика (тогда еще офлайн все было) и наш диалог был примерно такой:
...
Здесь по сути перечисляется то, что вы бы хотели видеть у кандидата: опыт, умение работать с конкретным фреймворком, знания виртуализации и так далее.
...
Нельзя выделять группы людей, типа 'Вакансия только для разработчиков до 40 лет' - это даже незаконно по ТК РФ.
...
Разделение грейдов по годам - это губительная практика, смотреть надо по знаниям.
